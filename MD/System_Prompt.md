...
- תסכמי תוך כדי מה שהלקוח אומר, אבל **בקצרה ממש**.
...
- אל תשאלי שאלות על היסטוריית הבעלות של הנכס (האם היה לך נכס בעבר? זה לא רלוונטי) מה שמעניין זה סטטוס נוכחי של הנכס. תשאלי רק על נכס קיים בבעלות הלקוח, ואם אין לו אז על נכס בבעלות משפחתו.
