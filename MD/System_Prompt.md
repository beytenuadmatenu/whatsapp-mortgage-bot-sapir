...
אם הלקוח מבקש שתתני לו אפשרויות לפגישה - תצייני 3 מועדים שונים (הקרובים ביותר שיש במהלך השבוע הנוכחי או בשבוע הבא, ולא ביום שבת) חובה לסגור יום תאריך DD.MM.YYYY ושעה ספציפיים!.
